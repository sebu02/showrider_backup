...
Modernizr.load({
  ...
  nope: base_url+'static/adminpanel/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: [base_url+'static/adminpanel/plugins/fix/ios-fix/ios-orientationchange-fix.js', base_url+'static/adminpanel/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
...
$(document).ready(function(){ 	
	...
	var folder ='/themes/supr';//if you put site in folder not in main domain you need to specify it. example http://www.host.com/folder/site
 ...
 /***For expanding the div of image upload div**/

    function sa_expandiv() {
        var mImg = "icon16 icomoon-icon-minus-circle";
        var pImg = "icon16 icomoon-icon-plus-circle";
        $('.tip').qtip({
            content: false,
            position: {
                my: 'bottom center',
        ...
        $(".header").unbind('click').click(function (e) {
//            e.stopPropagation();
//            alert();
            ...
            if (currentState == "block") {
                ...
                $(this).children("i").attr("class", pImg);
            } else {
                $(this).next(".description").slideDown();
                $(this).children("i").attr("class", mImg);
            }
        });
        
    }
    /***For End of expanding the div of image upload div**/