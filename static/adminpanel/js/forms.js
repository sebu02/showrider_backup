...
$(document).ready(function () {
    ...
    if ($('#combined-picker_a').length) {
        $('#combined-picker_a').datetimepicker({
            showSecond: true,
        });
    }
    //------------- Combined picker1 -------------//
    if ($('#combined-picker1').length) {
        $('#combined-picker1').datetimepicker({
            showSecond: true,
            timeFormat: 'hh:mm:ss',
            dateFormat: 'yy-mm-dd'
    ...
    if ($('#combined-picker1_b').length) {
        $('#combined-picker1_b').datetimepicker({
            showSecond: true,
            timeFormat: 'hh:mm:ss',
            dateFormat: 'yy-mm-dd'
    ...
    if ($('#combined-picker1_c').length) {
        $('#combined-picker1_c').datetimepicker({
            showSecond: true,
            timeFormat: 'hh:mm:ss',
            dateFormat: 'yy-mm-dd'
    ...
    if ($('#combined-picker1_d').length) {
        $('#combined-picker1_d').datetimepicker({
            showSecond: true,
            timeFormat: 'hh:mm:ss',
            dateFormat: 'yy-mm-dd'
    ...
    //------------- Combined picker2 -------------//
    if ($('#combined-picker2').length) {
        $("#combined-picker2").datepicker({
            changeMonth: true,
            changeYear: true,
            yearRange: "-100:+0",
            dateFormat: 'yy-mm-dd'
    ...
    $('textarea.tinymce').tinymce({
        ...
        script_url: base_url + 'static/adminpanel/plugins/forms/tiny_mce/tinymce.min.js',
