                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'videogalleryadmin/edit_category/' . $cat->id; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
