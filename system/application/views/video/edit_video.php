                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'videogalleryadmin/edit_video/'.$video->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $this->uri->segment(6); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <select class="custom-select parentid search_select" name="cat" required style="cursor: pointer;">
                                        ...
                                        foreach ($main_categories as $parent) {
                                            ...
                                            <option value="<?php echo $parent->id; ?>"                                                    
                                                    <?php if ($parent->id == $video->main_category) {
                                                        echo "selected";
                                                    } ?>>
                                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" value="<?php echo $video->title; ?>" placeholder="" required>
                                ...
                                <div class="form-group" style="display:none;">
                                    ...
                                    <div class="input-group mb-3">
                                        <textarea rows="4" name="description" id="description" class="form-control" aria-label=""><?php echo $video->description; ?></textarea>
                                    </div>  
                                </div>        
                                                                
                                <div class="form-group">
                                    <label for="video_link">Video Link</label>
                                    <input type="text" name="video_link" class="form-control" id="video_link" value="<?php echo $video->video_code; ?>" required>
                                ...
                                <?php
                                  $current_video_array = json_decode($video->video , TRUE);
                                  $current_video = $current_video_array['video']; 
                                  
                                  if($current_video != ""){
                                ?>

                                    <div class="form-group">
                                                <label for="normal">Current Video</label>
                                            
                                            <div class="form-group">                                                                                         
                                                
                                                <video style="width: 50%;" controls>
                                                <source src="<?php echo base_url() . 'video_library/' . $current_video; ?>" type="video/mp4">                                                
                                                </video>    
