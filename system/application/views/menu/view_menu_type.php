                                            ...
                                            <tr>                                                
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="<?php echo base_url(); ?>appearanceadmin/edit_menu_type/<?php echo $cat->id; ?>" title="Edit" class="text-secondary"><i class="fa fa-edit"></i></a></li>

                                                        <li><a href="javascript:void(0);" title="Remove" class="text-danger" onclick="linkRef('<?php echo base_url(); ?>appearanceadmin/trash_menu_type/<?php echo $cat->id; ?>')"><i class="ti-trash"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
