                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Edit Type</h4>
                            
                            
                            <div style="height: 30px;"></div>
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'appearanceadmin/edit_menu_type/' . $cat->id; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
