        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Settings</h4>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover progress-table text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><a
                                                        href="<?php echo base_url(); ?>optionadmin/add_mail_data/"
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Project Name Settings</td>
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><a
                                                        href="<?php echo base_url(); ?>optionadmin/add_project_data/"
                                                        title="Edit" class="text-secondary"><i
                                                            class="fa fa-edit"></i></a></li>
                                            </ul>
                                        </td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Common SEO Settings</td>
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><a
                                                        href="<?php echo base_url(); ?>optionadmin/add_seo_contents/"
                                                        title="Edit" class="text-secondary"><i
                                                            class="fa fa-edit"></i></a></li>
                                            </ul>
                                        </td>
                                    ...
                                    <tr style="display:none;">
                                        <td>4</td>
                                        <td>Social Media Settings</td>
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><a
                                                        href="<?php echo base_url(); ?>optionadmin/add_social_media/"
                                                        title="Edit" class="text-secondary"><i
                                                            class="fa fa-edit"></i></a></li>
                                            </ul>
                                        </td>
                                    ...
                                    <tr style="display:none;">
                                        <td>5</td>
                                        <td>Special Types Settings</td>
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><a
                                                        href="<?php echo base_url(); ?>optionadmin/add_heading_texts/"
                                                        title="Edit" class="text-secondary"><i
                                                            class="fa fa-edit"></i></a></li>
                                            </ul>
                                        </td>
