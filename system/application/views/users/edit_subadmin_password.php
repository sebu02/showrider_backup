                      ...
                      <div class="span6" style="width:70%; margin-left:15%;">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'useradmin/change_subadmin_password/'.$user_details->id.'?'.$_SERVER['QUERY_STRING'] ; ?>" method="post" enctype="multipart/form-data" />
