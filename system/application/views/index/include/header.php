<header class="full_wrapper header_full_wrpr hover_head_common header_inner active_logo">
    ...
    <div class="full_wrapper header_main_wrpr padding_lr_header_primary wrpr_flex flex_start">
        ...
        <div class="item_center ml_auto call_enquiry wrpr_flex margin_l_50 inner_pg">
            ...
            <ul class="wrpr_flex common_ul_type_1">
                ...
                if ($media_list != NULL) {
                    foreach ($media_list as $media_key => $media_row) {
                        ...
                        $active_class = "";
                        if($this->uri->segment(1) == $customized_link['type3']){
                            $active_class = "active";
                        }
                ?>
