                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'commonimageadmin/edit/' . $cat->id . $_SERVER['QUERY_STRING']; ?>" method="post" enctype="multipart/form-data" autocomplete="off">

                                <?php
                                 $parent_types = array("gallery image");
                                ?>

                                <div class="form-group" style="display:none;">
                                    <label class="col-form-label">Type<a style="color:#F00; font-size:12px;">*</a></label>
                                    <select class="custom-select search_select" name="parent_type" required style="cursor: pointer;">

                                        <!-- <option value="">--select--</option> -->

                                        <?php
                                        $i = 0;
                                        foreach ($parent_types as $parent_key => $parent_val) {
                                            ?>    
                                            <option value="<?php echo $parent_key; ?>"
                                                    
                                                    <?php if($cat->parent_id == $parent_key){ echo "selected"; } ?>>
                                        ...
                                        <!-- <option value="0" <?php // if($cat->parent_id == "0"){ echo "selected"; } ?>>None</option> -->
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">Degault File Combo                                        
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order_number" class="form-control" id="order_number" placeholder="" value="<?php echo $cat->order; ?>" required />
