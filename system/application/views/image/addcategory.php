                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'commonimageadmin/addcategory/?' . $_SERVER['QUERY_STRING']; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <select class="custom-select search_select" name="parent_type" required style="cursor: pointer;">
                                        ...
                                        foreach ($parent_types as $parent_key => $parent_val) {
                                            ...
                                            <option value="<?php echo $parent_key; ?>"
                                                    ...
                                                    <?php echo set_select('parent_type', $parent_key); ?>>
