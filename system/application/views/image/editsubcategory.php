            ...
            <div class="span6" style="width:70%; margin-left:15%;">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4> 
                            <span>Editing Sub Category</span>
                        </h4>

                    </div>
                    <div class="content">

                        <form class="form-horizontal multiple_upload_form" action="<?php echo base_url() . 'commonimageadmin/editSub/' . $cat->id; ?>" method="post" enctype="multipart/form-data" >
                                        ...
                                        <div class="span8 controls">   
                                            <select name="parentname" required>
                                                ...
                                                foreach ($categorylist as $sub) {
                                                     if($cat->id!=$sub['id']){
                                                    ?>
                                                    <option value="<?php echo $sub['id']; ?>" <?php if ($sub['id'] == $cat->parent_id) echo 'selected="selected"'; ?> ><?php echo $sub['name']; ?></option>
                                                    <?php
                                                }}
                                                ?>
                                            </select>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8" id="catname" type="text" name="catname" value="<?php echo $cat->category; ?>" required />
                                        <span class="error">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8 read-slug" readonly="true" id="slug" type="text" name="slug" value="<?php echo $cat->slug; ?>" required />
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8" id="order_number" type="text" name="order_number"  value="<?php echo $cat->order; ?>" required />
                                        <span class="error">
...
<?php
                           $banner= json_decode($cat->category_picture);
                                        ...
                                        <div class="span8 controls comboset">  
                                            <select name="combo" id="combo" class="combo">
                                                ...
                                                foreach ($values as $combos) {
                                                    ...
                                                    ?>
                                                    <option data-pref='<?php echo $combos->preferences; ?>' data-manip='<?php echo $combos->manipulation_status; ?>' <?php if($banner[0]->combo==$combos->fid){ echo 'selected';}?>  value="<?php echo $combos->fid; ?>" <?php if(isset($_POST['combo'])){if($_POST['combo']==$combos->fid){ echo 'selected'; }} ?> ><?php echo $combos->combo_name; ?></option>
                                                <?php } }?>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span4" for="normal">Sub Category Picture</label>
        ...
        $(document).ready(function () {
            ...
            $('#images').on('change', function () {
                ...
                if (checktotal == 0) {
                    ...
                    var formUrl = "<?php echo base_url() . 'commonimageadmin/bannerUpload'; ?>";
    ...
    <script type="text/javascript">
        ...
        function manipulationData() {;
            ...
            if (manip == 'Yes') {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "commonimageadmin/fetchManipdata/",
                    data: dataString,
                    cache: false,
...
//      file delete function 
       function deleteproductimage(img, count) {
           ...
           $.ajax({
               type: "POST",
               url: base_url + "commonimageadmin/delete_upload_image/",
               data: dataString,
               cache: false,
               success: function (html) {
...
function removeAllfiles() {
    ...
    if (finalFiles != '') {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "commonimageadmin/deleteFilechange/",
            data: dataString,
            cache: false,
            success: function (html) {
