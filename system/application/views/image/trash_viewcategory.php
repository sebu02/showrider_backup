                            ...
                            <tbody>
                                ...
                                foreach ($categories as $cat) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="javascript:void(0)" title="Restore Category" class="tip" onClick="restoreRef('<?php echo base_url(); ?>commonimageadmin/restoreCategory/<?php echo $cat->id; ?>')">
                                                <span class="icon12 icomoon-icon-undo-2"></span><strong>Restore Category</strong></a></td>
                                        <td class="center"><a href="javascript:void(0)" title="Remove Category" class="tip" onClick="linkRef('<?php echo base_url(); ?>commonimageadmin/deleteCategory/<?php echo $cat->id; ?>')">
