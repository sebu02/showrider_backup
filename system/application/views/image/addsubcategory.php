            ...
            <div class="span6" style="width:70%; margin-left:15%;">
                ...
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <form class="form-horizontal multiple_upload_form" action="<?php echo base_url() . 'commonimageadmin/addsubcategory/'; ?>" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8" id="order_number" type="text" name="order_number"  value="0" required />
                                        <span class="error">
