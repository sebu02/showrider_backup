            ...
            <!-- End search -->                  
				...
				?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    <a href="javascript:void(0)" title="Restore Extension" class="tip" onClick="restoreRef('<?php echo base_url(); ?>fileuploadadmin/restoreExtensions/<?php echo $sizevalues->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>')">
                                                        <span class="icon12 icomoon-icon-undo-2"></span><strong>Restore Extension</strong>
                                                    </a>
                                                </td> 
                                                <td class="center"><a href="javascript:void(0)" title="Remove Extension" class="tip" onClick="linkRef('<?php echo base_url();?>fileuploadadmin/deleteExtensions/<?php echo $sizevalues->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>')"><span class="icon12 icomoon-icon-remove"></span></a></td>                 
                                           </tr>
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url().'fileuploadadmin/trash_viewExtension/' ?>' + total_name;
