    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 col-sm-4 clearfix">
            <ul class="notification-area pull-right">
                <li class="gl_refresh_btn" data-refresh="<?php echo base_url() . 'fileuploadadmin/viewallCombo/'; ?>">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Combos</h4>
                                ...
                                <tbody>
                                    ...
                                    foreach ($values as $combovalues) {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php
                                                echo $combovalues->combo_name;
                                                ?>
                                            </td>
                                            <td>
                                                <ul class="d-flex justify-content-center">
                                                    <li class="mr-3"><a href="<?php echo base_url();?>fileuploadadmin/editCombo/<?php echo $combovalues->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>" class="text-secondary" title="Edit"><i class="fa fa-edit"></i></a></li>
                                                    <li><a href="#" class="text-danger"><i class="ti-trash" onclick="linkRef('<?php echo base_url();?>fileuploadadmin/trashCombo/<?php echo $combovalues->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>')" title="Remove"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'fileuploadadmin/viewallCombo/'; ?>' + total_name;
