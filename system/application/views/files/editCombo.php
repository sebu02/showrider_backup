        ...
        <div class="col-lg-6 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Edit Combo</h4>

                            <div style="height: 30px;"></div>
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'fileuploadadmin/editCombo/'.$this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" autocomplete="off">

                                <?php /**/ ?><?php /**/ ?>

                                <div class="form-group">
                                    <label for="combo_name">Name<a style="color:#F00; font-size:12px;">*</a></label>
                                    <input type="text" name="combo_name" class="form-control" id="combo_name" value="<?php echo $values->combo_name; ?>" placeholder="" required>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">Upload Type<a style="color:#F00; font-size:12px;">*</a></label>
                                    <select class="custom-select search_select" name="uploadtype" id="uploadtype" required style="cursor: pointer;">
                                        ...
                                        foreach ($data as $uploadtype) {
                                            ...
                                            <option value="<?php echo $uploadtype->id; ?>"                                                    
                                                    <?php                                                    
                                                    if($uploadtype->id==$values->upload_type){
                                                        echo 'selected';                                                        
                                                    }                                                   
                                                    ?>><?php
                                    ...
                                    <select class="custom-select search_select" name="manipulation" id="manipulation" required style="cursor: pointer;">
                                        ...
                                        foreach ($manipulations as $manip_data) {
                                            ...
                                            <option value="<?php echo $manip_data->id; ?>"
                                                    <?php if($manip_data->id==$values->manipulation){
                                                        echo 'selected';                                                        
                                                    }?>>
                                                <?php
