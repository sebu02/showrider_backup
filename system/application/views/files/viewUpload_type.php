    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 col-sm-4 clearfix">
            <ul class="notification-area pull-right">
                <li class="gl_refresh_btn" data-refresh="<?php echo base_url() . 'fileuploadadmin/viewUpload_type/'; ?>">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Upload Types</h4>
                            ...
                            <table class="table table-hover progress-table text-center">
                                <thead class="text-uppercase">
                                    <tr>
                                        ...
                                        <th scope="col">MANIPULATION STATUS</th>                                        
                                ...
                                <tbody>
                                    ...
                                    foreach ($values as $typevalues) {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php
                                                echo $typevalues->type_name;
                                                ?></td>
                                            <td>
                                                <?php
                                                echo $typevalues->manipulation_status;
                                                ?>

                                            </td>
                                            <td>
                                                <ul class="d-flex justify-content-center">
                                                    <li class="mr-3"><a href="<?php echo base_url(); ?>fileuploadadmin/editUpload_type/<?php echo $typevalues->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>" class="text-secondary" title="Edit"><i class="fa fa-edit"></i></a></li>
                                                    <li><a href="#" class="text-danger"><i class="ti-trash" onclick="linkRef('<?php echo base_url(); ?>fileuploadadmin/trashUpload_type/<?php echo $typevalues->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>')" title="Remove"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'fileuploadadmin/viewUpload_type/'; ?>' + total_name;
