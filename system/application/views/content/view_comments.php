...
//                        $typed = str_replace("123", "&", $typed);
        ...
        <div class="col-md-6 col-sm-4 clearfix">
            <ul class="notification-area pull-right">
                <li class="dropdown gl_refresh_btn" data-refresh="<?php echo base_url() . 'contentadmin/viewcomments/'; ?>">
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Manage Comments</h4>
        ...
        <div class="col-12 mt-1">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Comments</h4>
                                    ...
                                    if ($comments != NULL) {
                                        ...
                                        foreach ($comments as $p) {
                                            ...
                                            <tr>
                                                    ...
                                                    <td><?php                                         
                                                        $main_val=$this->content_model->GetByRow('ec_products', $p->product_id, 'id');
                                                        echo ucwords($main_val->product_title);?></td>
                                                    <td><?php echo $p->total_likes; ?></td>
                                                    <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li><a href="javascript:void(0);" title="Remove" class="text-danger" onclick="linkRef('<?php echo base_url() . 'contentadmin/delete_comments/' . $p->id ?>')"><i class="ti-trash"></i></a></li><?php /**/ ?>
                                                        </ul>
                                                    </td>
                                            </tr>
