                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() .  'contentadmin/addcategory?' . $_SERVER['QUERY_STRING']; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select parentid search_select" name="parent_page" required style="cursor: pointer;">
                                        ...
                                        foreach ($all_pages_list as $page_row) {
                                            ?>    
                                            <option value="<?php echo $page_row->id; ?>" <?php echo set_select('parent_page', $page_row->id); ?>>
                                                        <?php
                                                        echo $page_row->page;
                                                        ?></option>
                                            <?php
