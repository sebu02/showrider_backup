                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url() . 'contentadmin/edit_content_2/'.$current_id.'?'. $_SERVER['QUERY_STRING']; ?>"><button type="button" class="btn btn-flat btn-outline-success mb-3">STEP 2</button></a>

                            <div style="height: 30px;"></div>
                            <form class="multiple_upload_form" id="gl_current_image_upload_form_id" action="<?php echo base_url() . 'contentadmin/edit_content/' . $current_id . '/?' . $_SERVER['QUERY_STRING']; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select parentid search_select" name="cat" required style="cursor: pointer;">
                                        <option selected value="0" data-img_width="0" data-img_height="0">--select--</option>

                                        <?php
                                        $i = 0;
                                        foreach ($categorylist as $cat) {
                                            ?>    
                                            <option data-url="" value="<?php echo $cat['id']; ?>" <?php if ($single_detail->prod_cat == $cat['id']) {
                                            echo "selected"; } ?>
                                                    data-ctype="" data-img_width="<?php echo $cat['image_width']; ?>" data-img_height="<?php echo $cat['image_height']; ?>">
                                                        <?php
                                                        echo $cat['name'];
                                                        ?></option>
                                            <?php
                                ...
                                <?php /**/ ?><div class="form-group">
                                    <label for="title">Name<a style="color:#F00; font-size:12px;">*</a></label>
                                    <input type="text" name="catname" class="form-control slug_ref" id="catname" placeholder="" value="<?php echo $single_detail->title; ?>" required />
                                ...
                                <?php /**/ ?><div class="form-group">
                                    ...
                                    <input type="text" name="slug" value="<?php echo $single_detail->slug2; ?>" required class="form-control slug_url_val" readonly id="slug" placeholder="" />
