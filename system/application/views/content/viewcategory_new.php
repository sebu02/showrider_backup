                                    ...
                                    if ($categories != NULL) {
                                        ...
                                        foreach ($categories as $cat) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                       $parent_page_id = $cat->parent_page_id;
                                                       if($parent_page_id > 0){
                                                           $parent_page_row = $this->content_model->GetByRow_notrash('cms_pages', $parent_page_id, 'id');
                                                           echo $parent_page_row->page;
                                                       }else{
                                                           echo '---'; 
                                                       }
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="<?php echo base_url().'contentadmin/edit?id=' . $cat->id . '&'.$_SERVER['QUERY_STRING']; ?>" title="Edit" class="text-secondary"><i class="fa fa-edit"></i></a></li>

                                                        <li><a href="javascript:void(0);" title="Remove" class="text-danger" onclick="linkRef('<?php echo base_url() . 'contentadmin/trashCategory?id=' . $cat->id . '&' . $_SERVER['QUERY_STRING']; ?>')"><i class="ti-trash"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
