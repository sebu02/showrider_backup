            ...
            <div class="span6" style="width:70%; margin-left:15%;">
                ...
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <form class="form-horizontal multiple_upload_form" action="<?php echo base_url() . 'contentadmin/editSub/' . $cat->id; ?>" method="post" enctype="multipart/form-data" >
                           ...
                           $banner= json_decode($cat->category_picture);
                            ...
                            if ($banner[0]->image != '') {
                                ...
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        <div class="row-fluid">
                                            <label class="form-label span4" for="normal">Current Sub Category Picture</label>
