                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" id="gl_current_image_upload_form_id" action="<?php echo base_url() . 'contentadmin/add_content'; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select parentid search_select" name="cat" required style="cursor: pointer;">
                                        <option selected data-img_width="0" data-img_height="0" value="">--select--</option>

                                        <?php
                                        $i = 0;
                                        foreach ($categorylist as $cat) {
                                            ?>    
                                            <option data-url="" value="<?php echo $cat['id']; ?>" <?php echo set_select('cat', $cat['id']); ?>
                                ...
                                <?php /**/ ?><div class="form-group">
                                    ...
                                    <input type="text" name="catname" class="form-control slug_ref" id="catname" placeholder="" value="<?php echo set_value('catname'); ?>" required />
