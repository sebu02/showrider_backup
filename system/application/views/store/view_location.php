        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Locations</h4>
                            ...
                            <table class="table table-hover progress-table text-center">
                                <thead class="text-uppercase">
                                    <tr>
                                        ...
                                        <th scope="col">MAIN PARENT LOCATION</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        foreach ($values as $row) {
                                            ...
                                            <tr>                                                
                                                ...
                                                <td>
                                                    <?php
                                                    if ($row->parent_id != '0') {
                                                        $parent = $this->common_model->GetByRow('cms_locations', $row->parent_id, 'id');
                                                        if(!empty($parent)){
                                                           echo ucwords($parent->location);
                                                        }
                                                    } else {
                                                        echo ucwords($row->location);
                                                    }
                                                    ?>
                                                </td>
                                                <td>                                                    
                                                        <?php
                                                            if ($row->main_parent_id != '0') {
                                                                $main_parent = $this->common_model->GetByRow('cms_locations', $row->main_parent_id, 'id');
                                                                echo ucwords($main_parent->location);
                                                            } else {
                                                                echo ucwords($row->location);
                                                            }
                                                        ?> 
