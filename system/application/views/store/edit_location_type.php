            ...
            <div class="span6" style="width:70%; margin-left:15%;">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4> 
                            <span>Edit Location Type</span>
                        </h4>

                    </div>
                    <div class="content">

                            <form class="form-horizontal multiple_upload_form" role="form" action="<?php echo base_url() . 'cmsstorefinderadmin/edit_location_type?' . $_SERVER['QUERY_STRING']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    ...
                                    <option <?php if($p['id'] == $val->id){ echo 'disabled'; } ?> value="<?php echo $p['id']; ?>" <?php
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8 slug_ref" id="location_type" type="text" name="location_type"  value="<?php echo $val->location_type; ?>" required />
                                        <span class="error">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span6 read-slug slug_url_val" readonly="true" id="slug" type="text" name="location_key" value="<?php echo $val->location_key; ?>" required/>
