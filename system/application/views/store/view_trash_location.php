 ...
 <div class="form-row row-fluid" style="width:40%; float:right ;">
            <div class="span12">
                <div class="row-fluid">
                            ...
                            <a href="<?php echo base_url(); ?>cmsstorefinderadmin/view_trash_location/" class="btn btn-inverse"><span
        ...
        <?php /* ?>
                                <a class="btn bg-purple btn-xs" style="margin-right:10px;" href="<?php echo base_url() . 'cmsstorefinderadmin/view_trash_location?' . $newuristrings; ?>"><?php echo $typed; ?> &nbsp;&nbsp;<i class="fa fa-times-circle"></i></a>
                                <?php /**/ ?>
                                <?php
                            }
                            ?>
                            ...
                            <tbody>
                                ...
                                foreach ($values as $row) {
                                    ...
                                    <td><?php echo ucwords($row->location); ?></td>
                                                    ...
                                                    <td class="center">
                                                        <a  href="<?php echo base_url() . 'cmsstorefinderadmin/restore_location?id=' . $row->id . $_SERVER['QUERY_STRING']; ?>" title="Restore Location" class="tip">Restore</a>
                                                    </td>
                                                    
                                                    <td class="center">
                                                        <a  href="javascript:void(0)" title="Delete Location" onClick="linkRef('<?php echo base_url() . 'cmsstorefinderadmin/permanent_delete_location?id=' . $row->id . $_SERVER['QUERY_STRING']; ?>')" > <span class="icon12 icomoon-icon-remove"></span></a>
                                                    </td>
...
?>
            window.location = '<?php echo base_url() . 'cmsstorefinderadmin/view_trash_location?' . $uriarrays; ?>&seg3=' + name;
