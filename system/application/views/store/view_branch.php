 ...
 <div class="form-row row-fluid" style="width:40%; float:right ;">
            <div class="span12">
                <div class="row-fluid">
                            ...
                            <a href="<?php echo base_url(); ?>cmsstorefinderadmin/view_branch/" class="btn btn-inverse"><span
        ...
        <?php /* ?>
                                <a class="btn bg-purple btn-xs" style="margin-right:10px;" href="<?php echo base_url() . 'cmsstorefinderadmin/view_branch?' . $newuristrings; ?>"><?php echo $typed; ?> &nbsp;&nbsp;<i class="fa fa-times-circle"></i></a>
                                <?php /**/ ?>
                                <?php
                            }
                            ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0"
                            ...
                            <tbody>
                                ...
                                foreach ($values as $row) {
                                    ...
                                    <!--<td>
                                        <?php
                                        $location = $this->common_model->GetByRow('cms_locations', $row->location_id, 'id');
                                    ...
                                    <td><?php echo $row->address; ?></td>
                                                    ...
                                                    <td class="center">
                                                        <a  href="<?php echo base_url() . 'cmsstorefinderadmin/edit_branch?id=' . $row->id . $_SERVER['QUERY_STRING']; ?>" title="Edit Branch" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
                                                    </td>
                                                    
                                                    <td class="center">
                                                        <a  href="javascript:void(0)" title="Delete Branch" onClick="linkRef('<?php echo base_url() . 'cmsstorefinderadmin/delete_branch?id=' . $row->id . $_SERVER['QUERY_STRING']; ?>')" > <span class="icon12 icomoon-icon-remove"></span></a>
                                                    </td>
...
?>
            window.location = '<?php echo base_url() . 'cmsstorefinderadmin/view_branch?' . $uriarrays; ?>&seg3=' + name;
