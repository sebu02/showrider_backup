        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Trash Mails</h4>
                                ...
                                <tbody>
                                    ...
                                    if ($item_list != NULL) {
                                        ...
                                        foreach ($item_list as $item_row) {
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $item_row->form_name; ?></td>
                                                <td><?php
                                                    foreach ($form_data as $form_key => $form_value) {
                                                        if (ucfirst($form_key) == "Career_File") {
                                                            ...
                                                            echo '<label class="col-form-label">' . ucfirst($form_key) . ':</label> ' . $form_value . '<br/>';
                                                        }
                                                    }
                                                    ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="javascript:void(0)" title="Restore" class="text-secondary" onclick="restoreRef('<?php echo base_url(); ?>cmsmailsadmin/restore_mails/<?php echo $item_row->id . '?' . $_SERVER['QUERY_STRING']; ?>')"><i class="fa fa-undo"></i></a></li>
                                                        <li><a href="javascript:void(0)" title="Remove" class="text-danger" onclick="linkRef('<?php echo base_url(); ?>cmsmailsadmin/delete_mails/<?php echo $item_row->id . '?' . $_SERVER['QUERY_STRING']; ?>')"><i class="ti-trash"></i></a></li>
                                                    </ul>
