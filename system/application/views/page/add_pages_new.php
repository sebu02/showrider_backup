                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'pageadmin/add_pages?' . $_SERVER["QUERY_STRING"]; ?>" method="post" enctype="multipart/form-data" autocomplete="off">

                                <div class="form-group">
                                    <label for="page">Name<a style="color:#F00; font-size:12px;">*</a></label>
                                    <input type="text" name="page" class="form-control slug_ref" id="page" value="<?php echo set_value('page'); ?>" placeholder="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="2" name="title" id="title" class="form-control" placeholder="" aria-label="" required><?php echo set_value('title'); ?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="3" name="description" id="description" class="form-control" placeholder="" aria-label="" required><?php echo set_value('description'); ?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="3" name="keywords" id="tags" class="form-control" placeholder="" aria-label="" required><?php echo set_value('keywords'); ?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="10" name="extra_code" id="codes" class="form-control" placeholder="" aria-label=""><?php echo set_value('extra_code'); ?></textarea>
                                    </div>
