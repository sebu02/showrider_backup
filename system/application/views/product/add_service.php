                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'ecproductadmin/add_service/'; ?>" method="post" enctype="multipart/form-data" autocomplete="off" id="gl_current_image_upload_form_id">

                                <div class="form-group">
                                    <label for="service_name">Name<a style="color:#F00; font-size:12px;">*</a></label>
                                    <input type="text" name="service_name" class="form-control" id="service_name" value="<?php echo set_value('service_name'); ?>" placeholder="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_code" class="form-control" id="event_code" value="<?php echo $event_sku; ?>" required readonly>
                                ...
                                <div class="form-group" style="display:none;">
                                    ...
                                    <input type="text" name="part_number" class="form-control" id="part_number" value="<?php echo set_value('part_number'); ?>">

                                    <span class="error">
                                        <?php // echo form_error('part_number'); ?>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" value="<?php echo set_value('title'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="4" name="short_description" id="short_description" class="form-control" ><?php echo set_value('short_description'); ?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="5" name="brief_description" id="editor" class="form-control" ><?php echo set_value('brief_description'); ?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="event_date" class="form-control" id="event_date" value="<?php echo set_value('event_date'); ?>" required />

                                </div>
                                                                
                                <div class="form-group">
                                    <label for="from_time">From Time</label>
                                    <input type="time" name="from_time" class="form-control" id="from_time" value="<?php echo set_value('from_time'); ?>" />

                                </div>

                                <div class="form-group">
                                    <label for="to_time">To Time</label>
                                    <input type="time" name="to_time" class="form-control" id="to_time" value="<?php echo set_value('to_time'); ?>" />

                                </div>
                                                                
                                <div class="form-group" style="display:none;">
                                    <label for="alt_pn">Alt Pn</label>
                                    <input type="text" name="alt_pn" class="form-control" id="alt_pn" value="<?php echo set_value('alt_pn'); ?>" />

                                </div>
                                
                                <div class="form-group" style="display:none;">
                                    <label for="cage">Cage</label>
                                    <input type="text" name="cage" class="form-control" id="cage" value="<?php echo set_value('cage'); ?>" />
