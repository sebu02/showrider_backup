    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 col-sm-4 clearfix">
            <ul class="notification-area pull-right">
                <li class="dropdown gl_refresh_btn" data-refresh="<?php echo base_url() . 'ecproductadmin/view_ticket_types/'; ?>">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">View Ticket Types</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="<?php echo base_url() . 'ecproductadmin/edit_ticket_type?' . $_SERVER['QUERY_STRING'] . '&id=' . $row->id; ?>" title="Edit" class="text-secondary"><i class="fa fa-edit"></i></a></li>
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            /* */   if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'ecproductadmin/view_ticket_types?name='; ?>' + total_name;
