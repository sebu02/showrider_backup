<div id="content" class="clearfix">
    <div class="contentwrapper"><!--Content wrapper-->
        ...
        <a href="<?php echo base_url(); ?>ecproductadmin/view_categorytype" class="btn btn-inverse"><span
                            ...
                            <tbody>
                                ...
                                foreach ($view_items_list as $row) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        $main_val=$this->product_model->GetByRow('ec_categorytypes', $row->main_type_id, 'id');
                                        echo strtoupper($main_val->category_type_name);?></td>
                                        ...
                                        <td class="center"> 
                                            <a href="<?php echo base_url(); ?>ecproductadmin/edit_categorytype/<?php echo $row->id; ?>" title="Edit Category Type" class="tip">
                                                <span class="icon12 icomoon-icon-pencil"></span>
                                            </a>
                                        </td>
                                        <td class="center">
                                            <a href="javascript:void(0)" title="Remove Category Type" class="tip" onClick="linkRef('<?php echo base_url(); ?>ecproductadmin/trash_categorytype/<?php echo $row->id; ?>')">
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'ecproductadmin/view_categorytype/'; ?>' + total_name;
