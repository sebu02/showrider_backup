                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url() . 'ecproductadmin/edit_prodcategory2?id=' . $single_detail->id . $per_page; ?>"><button type="button" class="btn btn-flat btn-outline-success mb-3">STEP 2</button></a>
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'ecproductadmin/edit_prodcategory3?' . $_SERVER['QUERY_STRING']; ?>" method="post" enctype="multipart/form-data" autocomplete="off" id="gl_current_image_upload_form_id">
                                ...
                                $banner_seo_alt = '';
                                $banner_seo_title = '';
                                $banner = json_decode($single_detail->banner);
                                ...
                                if ($banner != NULL) {
                                    if ($banner[0]->image != '') {
                                        ...
                                        <div class="form-group" >
                                                <label for="normal">Detail Image</label>
