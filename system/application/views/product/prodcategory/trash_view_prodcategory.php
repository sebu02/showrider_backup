<div id="content" class="clearfix">
    <div class="contentwrapper"><!--Content wrapper-->
        ...
        <a href="<?php echo base_url(); ?>ecproductadmin/trash_view_prodcategory/0/<?php echo $this->uri->segment(4); ?>" class="btn btn-inverse"><span
                            ...
                            <tbody>
                                ...
                                foreach ($view_items_list as $row) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a href="javascript:void(0)" title="Restore Category Type" class="tip" onClick="restoreRef('<?php echo base_url(); ?>ecproductadmin/restore_prodcategory/<?php echo $row->id; ?>/<?php echo $this->uri->segment(4); ?>')">
                                                <span class="icon12 icomoon-icon-undo-2"></span><strong>Restore  Category Type</strong>
                                            </a>
                                        </td>   
                                        <td class="center">
                                            <a href="javascript:void(0)" title="Remove Category Type" class="tip" onClick="linkRef('<?php echo base_url(); ?>ecproductadmin/delete_prodcategory/<?php echo $row->id; ?>/<?php echo $this->uri->segment(4); ?>')">
...
<script type="text/javascript">
    ...
    function trash_prod_search() {
            ...
            window.location = '<?php echo base_url() . 'ecproductadmin/trash_view_prodcategory/'; ?>' + total_name + '/' + seg4;
