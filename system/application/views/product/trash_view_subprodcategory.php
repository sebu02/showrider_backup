<div id="content" class="clearfix">
    <div class="contentwrapper"><!--Content wrapper-->
        ...
        <a href="<?php echo base_url(); ?>ecproductadmin/trash_view_subprodcategory" class="btn btn-inverse"><span
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box gradient">
                    <div class="title">
                        <h4>
                            <span>View Trash Sub Category</span>
                        </h4>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($view_items_list as $row) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a href="javascript:void(0)" title="Restore Category Type" class="tip" onClick="restoreRef('<?php echo base_url(); ?>ecproductadmin/restore_subprodcategory/<?php echo $row->id; ?>')">
                                                <span class="icon12 icomoon-icon-undo-2"></span><strong>Restore  Category Type</strong>
                                            </a>
                                        </td>   
                                        <td class="center">
                                            <a href="javascript:void(0)" title="Remove Category Type" class="tip" onClick="linkRef('<?php echo base_url(); ?>ecproductadmin/delete_subprodcategory/<?php echo $row->id; ?>')">
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'ecproductadmin/trash_view_subprodcategory/'; ?>' + total_name;
