                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'ecproductadmin/add_package/'; ?>" method="post" enctype="multipart/form-data" autocomplete="off" id="gl_current_image_upload_form_id">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="category[]" class="custom-control-input gl_category" id="category_<?php echo $category_key; ?>" value="<?php echo $category_row->id; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="package_name" class="form-control" id="package_name" value="<?php echo set_value('package_name'); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="package_code" class="form-control" id="package_code" value="<?php echo $package_sku; ?>" required readonly>
                                ...
                                <div class="form-group gl_price_input_div" style="display:none;">
                                    <label for="price">Price</label>
                                    <input type="number" name="price" class="form-control gl_price_input" id="price" value="<?php echo set_value('price'); ?>" >
