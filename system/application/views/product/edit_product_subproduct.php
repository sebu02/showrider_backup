            ...
            <div class="span6" style="width:70%; margin-left:15%;">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4> 
                            <span>Edit Sub Product</span>
                        </h4>

                    </div>
                    <div class="content">

                        <form class="form-horizontal multiple_upload_form" action="<?php echo base_url() . 'ecproductadmin/edit_subproduct/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) ?>" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-row row-fluid"> 
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span4">Product Name</label>
                          ...
                          <?php
                            $banner = json_decode($product->product_subcontent);
                            ...
                            if ($banner[$pos]->image != '') {
                                ...
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        <div class="row-fluid">
                                            <label class="form-label span4" for="normal">Current Sub Product Image</label>
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span4" for="normal">Title</label>
                                          <input class="span8" type="text" name="title" value="<?php echo $banner[$pos]->title;?>" />
                                        <span class="error">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <textarea class="span8 elastic ckeditor" id="editor_content" name="brief_details"><?php echo set_value('brief_details', $banner[$pos]->brief_details); ?></textarea>
                                        <span class="error">
                                            <?php echo form_error('brief_details'); ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <select name="combo" id="combo" class="combo">
                                                ...
                                                foreach ($values as $combos) {
                                                    ...
                                                    if ($combos->manipulation_status == 'Yes') { // (IMG_MANIPULATION_COMBO) when need all combos remove this condition
                                                        ?>
                                                        <option data-pref='<?php echo $combos->preferences; ?>' data-manip='<?php echo $combos->manipulation_status; ?>' value="<?php echo $combos->fid; ?>"
                                                         <?php
                                                        ...
                                                        if($banner[$pos]->combo==$combos->fid){ echo 'selected';}?> >
