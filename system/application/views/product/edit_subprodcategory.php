        ...
        <div class="row-fluid">
            <div class="span6" style="width:70%; margin-left:15%;">
                <div class="box">
                    ...
                    <div class="content">
                        <form class="form-horizontal multiple_upload_form" action="<?php echo base_url() . 'ecproductadmin/edit_subprodcategory/'.$this->uri->segment(3); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="span8 controls">   
                                        <select name="parentname" required id="category_type">
                                            ...
                                            foreach ($categorylist as $sub) {
                                                if($single_detail->id!=$sub['id']){
                                            ?>
                                                <option value="<?php echo $sub['id']; ?>"  data-ctype="<?php echo $sub['ctype']; ?>"  <?php if ($sub['id'] == $single_detail->parent_id) echo 'selected="selected"'; ?> ><?php echo $sub['name'].'--'.$sub['ctype_name']; ?></option>
                                            <?php
                                            } }
                                            ?>
                                        </select>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8" id="input_name" type="text" name="input_name" value="<?php echo $single_detail->category; ?>" required/>
                                        <span class="error">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8 read-slug" readonly="true" id="slug" type="text" name="slug" value="<?php echo $single_detail->slug; ?>" required/>
                             ...
                             <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8" id="short_name" type="text" name="short_name" required value="<?php echo $single_detail->short_name; ?>"/>
                      ...
                      <?php
                           $banner= json_decode($single_detail->category_picture);
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                   <div class="row-fluid currentCombo">
                                    ...
                                    <span class="manipTxt findAllcombo"><a onclick="allComboshow()">Show/ Change All File Properties</a></span>
                                    <div class="row-fluid comboSection" style="display: none">
                                                ...
                                                foreach ($values as $combos) {
                                                   ...
                                                   <option data-pref='<?php echo $combos->preferences; ?>' 
                                                           data-manip='<?php echo $combos->manipulation_status; ?>' 
                                                               <?php if($banner[0]->combo==$combos->fid){ echo 'selected';}?> 
                                                           value="<?php echo $combos->fid; ?>" 
                                                               <?php if(isset($_POST['combo'])){if($_POST['combo']==$combos->fid){ echo 'selected'; }} ?> ><?php echo $combos->combo_name; ?></option>
                            ...
                            <?php
                           $banner_b= json_decode($single_detail->banner);
                            ...
                            if ($banner_b[0]->image != '') {
                                ...
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        <div class="row-fluid">
                                            <label class="form-label span4" for="normal">Current Banner Picture</label>
                                            <img  class="span4"  src="<?php echo base_url().'media_library/'.$banner_b[0]->image; ?>" />  
                                            <input type="hidden" name="mediaID_b" value="<?php echo $banner_b[0]->media_id; ?>" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid currentCombo_b">
                                         <label class="form-label span4" for="normal">File Property</label>
                                         <?php foreach ($values as $combos) {
                                             if($banner[0]->combo==$combos->fid){ ?>
                                                 <input class="span8" readonly="true" value="<?php echo $combos->combo_name;?>"  />
                                    ...
                                    <span class="manipTxt findAllcombo_b"><a onclick="allComboshow_b()">Show/ Change All File Properties</a></span>
                                    <div class="row-fluid comboSection_b" style="display: none">
                                        ...
                                        <div class="span8 controls comboset_b">  
                                            <select name="combo_b" id="combo_b" class="combo_b">
                                                ...
                                                foreach ($values as $combos) {
                                                    ?>
                                                       <option data-pref='<?php echo $combos->preferences; ?>' data-manip='<?php echo $combos->manipulation_status; ?>' <?php if($banner_b[0]->combo==$combos->fid){ echo 'selected';}?> value="<?php echo $combos->fid; ?>" <?php if(isset($_POST['combo_b'])){if($_POST['combo_b']==$combos->fid){ echo 'selected'; }} ?> ><?php echo $combos->combo_name; ?></option>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span8" id="order_number" type="number" name="order_number"  value="<?php echo $single_detail->order_no; ?>" required />
                            ...
                            <div class="form-row row-fluid">
                              ...
                              <?php $spl_categories = json_decode($single_detail->spl_categories,TRUE);
                                    $spl_categories_id_list = array();
                                    foreach ($spl_categories as $spl_categories_row){
                                        array_push($spl_categories_id_list,$spl_categories_row['category_id']);
                                    }
                            ?>
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span8 controls gl-columns "> 
                                            <?php foreach ($main_categories as $key => $category_row) { 
                                                if (in_array($category_row->id, $spl_categories_id_list)) { ?>
                                                    <label class="span6 checkbox-inline checked" for="gl_Checkboxes_<?php echo $key; ?>">
                                                    <input type="checkbox" name="Checkboxes" checked id="gl_Checkboxes_<?php echo $key; ?>" data_id="<?php echo $category_row->id; ?>" data_slug="<?php echo $category_row->slug; ?>"  value="<?php echo $category_row->category; ?>">
                                        ...
                                        <input type="hidden" name="final_spl_categories" value="" id="final_spl_categories">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <textarea class="span8 elastic" id="page_title" rows="2" required name="page_title"><?php echo $single_detail->title; ?></textarea>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <textarea class="span8 elastic" id="seo_description" rows="3" required name="seo_description"><?php echo $single_detail->description; ?></textarea>
                            ...
                            <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span8 controls">
                                            <input id="tags" required name="seo_keywords" type="text" value="<?php echo $single_detail->keywords; ?>" style="width:100%;"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
