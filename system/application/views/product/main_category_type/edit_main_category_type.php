            ...
            <div class="span6" style="width:70%; margin-left:15%;">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4> 
                            <span>Edit Main Category Type</span>
                        </h4>

                    </div>
                    <div class="content">

                        <form class="form-horizontal extensionForm" action="<?php echo base_url() . 'ecproductadmin/edit_main_categorytype/' . $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5"
                                               ...
                                               value="<?php echo $single_detail->category_type_name; ?>" 
                                               required />
                                ...
                                <div class="span12">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5"
                                               ...
                                               value="<?php echo $single_detail->category_type_value; ?>" 
                                               required
                                               readonly
                                               />
