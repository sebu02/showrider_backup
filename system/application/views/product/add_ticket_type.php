                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Add Ticket Type</h4>
                                                        
                            <div style="height: 30px;"></div>
                            <form class="multiple_upload_form" action="<?php echo base_url() . 'ecproductadmin/add_ticket_type/'; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <select class="custom-select search_select" name="category" required style="cursor: pointer;">
                                        ...
                                        foreach ($events_list as $event) {
                                            ...
                                            <option value="<?php echo $event->id; ?>"
                                                    ...
                                                    <?php echo set_select('category', $event->id); ?>>
                                                        <?php
                                                        echo $event->name;
                                                        ?></option>
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ticket_name" class="form-control" id="ticket_name" value="<?php echo set_value('ticket_name'); ?>" placeholder="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ticket_code" class="form-control" id="ticket_code" value="<?php echo $ticket_sku; ?>" required readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_number" class="form-control" id="total_number" value="<?php echo set_value('total_number'); ?>" min="0">
